...
export function registerDeleteConfig(server: McpServer) {
    server.tool(
        "delete-config",
        "Delete the value of a key in configuration. You must call this command with the --key <key> option or with the --all option.",
        {
